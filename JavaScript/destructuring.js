...
function createStudent({ likesES2015 = true, likesJavaScript = true } = {}) {
    ...
    if (likesES2015 && likesJavaScript) return `${start} likes JavaScript and ES2015!`;
    else if (likesES2015) return `${start} likes ES2015!`;
    else if (likesJavaScript) return `${start} likes JavaScript!`;
    else return `${start} does not like much...`;
}
